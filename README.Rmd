...
## About the name
Well ... `midiR` was taken. `pyramidi` uses `mido` to access MIDI
files, and "MY-dough" is how I pronounce `mido`. `pyramidi` has
many features I don't need. So ... `mydough` - only what I ...
knead.
